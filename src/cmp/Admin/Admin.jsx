...
const Admin = ()=>{
  ...
  //drwer list matlab uske andar menu banaya gaya hai by map
  const Nav = ({data})=>{
  ...
  const MenuList = ({admin})=>{
    ...
    const menuDesign = (
      <>
        <List subheader={<ListSubheader><h3>{admin.cat}</h3></ListSubheader>}>
          {
...
// breadcrumbs showing for path
  const BreadLink = ({data})=>{
    return <Typography style={{
      textTransform:"capitalize",
      color: data.index === data.length ? "green" : null
      ...
      <Stack>
       ...
       <MediaQuery maxWidth={1224}>
        ...
        <AppBar color="inherit" elevation={0} position="fixed" sx={{
          ...
          <Toolbar>
            <Stack direction="row" alignItems="center" spacing="5px" sx={{pr:4}}>
            ...
            <Avatar src="https://mui.com/static/images/avatar/2.jpg">A</Avatar>
            </IconButton>
        ...
        <Stack sx={{
         ...
         <Breadcrumbs aria-label="breadcrumbs" sx={{my:4}}>
        {
